					...
					'<div class="layout-wrap">' +								
						'<div class="d-flex align-items-center">' +
							'<div class="status-toggle d-flex align-items-center me-2">' +
								...
								'<label for="1" class="checktoggle"><a  href="https://dreamspos.dreamguystech.com/laravel/template/public/index" class="layout-link">checkbox</a> </label>' + 
							'</div>' +
				...
				'<div class="col-xl-6 ere">' +
					'<div class="layout-wrap">' +								
						'<div class="d-flex align-items-center">' +
							'<div class="status-toggle d-flex align-items-center me-2">' +
								'<input type="checkbox" id="1" class="check">' +
								'<label for="1" class="checktoggle"><a  href="https://dreamspos.dreamguystech.com/laravel/template-rtl/public/index" class="layout-link">checkbox</a> </label>' + 
							'</div>' +
