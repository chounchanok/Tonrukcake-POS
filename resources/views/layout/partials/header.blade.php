...
@endif
		...
		<li class="nav-item dropdown nav-item-box">
			...
			<div class="dropdown-menu notifications">
				<div class="topnav-dropdown-header">
					<span class="notification-title">แจ้งเตือน</span>
					<a href="javascript:void(0)" class="clear-noti"> ล้างการแจ้งเตือน </a>
				</div>
				...
				<div class="topnav-dropdown-footer">
					<a href="{{url('activities')}}">แจ้งเตือนทั้งหมด</a>
				</div>
			</div>
		</li>
		...
		<li class="nav-item dropdown has-arrow main-drop">
			...
			<div class="dropdown-menu menu-drop-user">
				<div class="profilename">
					...
					<hr class="m-0">
					<a class="dropdown-item" href="{{url('profile')}}"> <i class="me-2"  data-feather="user"></i> โปรไฟล์ผู้ใช้งาน</a>
					<a class="dropdown-item" href="{{url('generalsettings')}}"><i class="me-2" data-feather="settings"></i>ตั้งค่า</a>
					<hr class="m-0">
					<a class="dropdown-item logout pb-0" href="{{url('signin')}}"><img src="{{ URL::asset('/assets/img/icons/log-out.svg')}}" class="me-2" alt="img">ออกจากระบบ</a>
				</div>
			</div>
		</li>
	</ul>
	...
	<div class="dropdown mobile-user-menu">
		...
		<div class="dropdown-menu dropdown-menu-right">
			<a class="dropdown-item" href="{{url('profile')}}">โปรไฟล์ผู้ใช้งาน</a>
			<a class="dropdown-item" href="{{url('generalsettings')}}">ตั้งค่า</a>
			<a class="dropdown-item" href="{{url('signin')}}">ออกจากระบบ</a>
		</div>
	</div>
	<!-- /Mobile Menu -->
	@if(Route::is(['index-three']))
